...
static lm_ggml_backend_reg_t lm_ggml_backend_load_best(const char * name, bool silent) {
...
void lm_ggml_backend_load_all() {
    lm_ggml_backend_load_best("blas", true);
    lm_ggml_backend_load_best("cann", true);
    lm_ggml_backend_load_best("cuda", true);
    lm_ggml_backend_load_best("hip", true);
    lm_ggml_backend_load_best("kompute", true);
    lm_ggml_backend_load_best("metal", true);
    lm_ggml_backend_load_best("rpc", true);
    lm_ggml_backend_load_best("sycl", true);
    lm_ggml_backend_load_best("vulkan", true);
    lm_ggml_backend_load_best("musa", true);
    lm_ggml_backend_load_best("cpu", true);
}
