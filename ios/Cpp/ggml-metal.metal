...
//
#if __METAL_VERSION__ < 310 && defined(LM_GGML_METAL_USE_BF16)
#undef LM_GGML_METAL_USE_BF16
#endif
...
kernel void kernel_add(
        constant lm_ggml_metal_kargs_bin & args,
...
kernel void kernel_repeat(
        constant lm_ggml_metal_kargs_repeat & args,
        device const char * src0,
        device       char * dst,
        uint3   tgpig[[threadgroup_position_in_grid]],
        ushort3 tpitg[[thread_position_in_threadgroup]],
...
// ref: ggml.c:lm_ggml_compute_forward_ssm_conv_f32
// TODO: optimize
...
// ref: ggml.c:lm_ggml_compute_forward_ssm_scan_f32
// TODO: optimize
...
kernel void kernel_norm(
        constant lm_ggml_metal_kargs_norm & args,
        device const char * src0,
        device       char * dst,
...
kernel void kernel_rms_norm(
        constant lm_ggml_metal_kargs_rms_norm & args,
        device const char * src0,
        device       char * dst,
        threadgroup float * shmem_f32 [[threadgroup(0)]],
        uint   tgpig[[threadgroup_position_in_grid]],
...
kernel void kernel_mul_mv_q4_0_f32(
        constant lm_ggml_metal_kargs_mul_mv & args,
        device const char * src0,
        device const char * src1,
        device       char * dst,
        uint3  tgpig[[threadgroup_position_in_grid]],
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
    mul_vec_q_n_f32_impl<block_q4_0, N_DST, N_SIMDGROUP, N_SIMDWIDTH, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q4_1_f32(
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
     mul_vec_q_n_f32_impl<block_q4_1, N_DST, N_SIMDGROUP, N_SIMDWIDTH, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q5_0_f32(
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
    mul_vec_q_n_f32_impl<block_q5_0, N_DST, N_SIMDGROUP, N_SIMDWIDTH, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q5_1_f32(
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
    mul_vec_q_n_f32_impl<block_q5_1, N_DST, N_SIMDGROUP, N_SIMDWIDTH, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q8_0_f32(
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
    kernel_mul_mv_q8_0_f32_impl<constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv(
        ...
        uint3  tgpig[[threadgroup_position_in_grid]],
        ushort tiisg[[thread_index_in_simdgroup]]) {
    kernel_mul_mv_impl<T0, T04, T1, T14, constant lm_ggml_metal_kargs_mul_mv &>(
        args,
        src0,
        src1,
        dst,
...
kernel void kernel_rope_norm(
        constant lm_ggml_metal_kargs_rope & args,
        device const char * src0,
        device const char * src1,
            ...
            if (ixj > col) {
                if ((col & k) == 0) {
                    if (dst_row[col] >= ncols ||
                        (dst_row[ixj] < ncols && (order == LM_GGML_SORT_ORDER_ASC ?
                    ...
                    if (dst_row[ixj] >= ncols ||
                        (dst_row[col] < ncols && (order == LM_GGML_SORT_ORDER_ASC ?
                            x_row[dst_row[col]] < x_row[dst_row[ixj]] :
                            x_row[dst_row[col]] > x_row[dst_row[ixj]]))
                    ) {
                        SWAP(dst_row[col], dst_row[ixj]);
...
kernel void kernel_flash_attn_ext(
        constant lm_ggml_metal_kargs_flash_attn_ext & args,
        device const char * q,
        device const char * k,
        device const char * v,
...
kernel void kernel_mul_mv_q2_K_f32(
    ...
    kernel_mul_mv_q2_K_f32_impl<constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q3_K_f32(
    ...
    kernel_mul_mv_q3_K_f32_impl<constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q4_K_f32(
    ...
    kernel_mul_mv_q4_K_f32_impl<constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q5_K_f32(
    ...
    kernel_mul_mv_q5_K_f32_impl<constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q6_K_f32(
    ...
    kernel_mul_mv_q6_K_f32_impl<constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq2_xxs_f32(
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
    kernel_mul_mv_iq2_xxs_f32_impl<constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq2_xs_f32(
    ...
    kernel_mul_mv_iq2_xs_f32_impl<constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq3_xxs_f32(
    ...
    kernel_mul_mv_iq3_xxs_f32_impl<constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq3_s_f32(
    ...
    kernel_mul_mv_iq3_s_f32_impl<constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq2_s_f32(
    ...
    kernel_mul_mv_iq2_s_f32_impl<constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq1_s_f32(
    ...
    kernel_mul_mv_iq1_s_f32_impl<constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq1_m_f32(
    ...
    kernel_mul_mv_iq1_m_f32_impl<constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq4_nl_f32(
    ...
    kernel_mul_mv_iq4_nl_f32_impl<constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq4_xs_f32(
    ...
    kernel_mul_mv_iq4_xs_f32_impl<constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mm(
        constant lm_ggml_metal_kargs_mul_mm & args,
        device const char * src0,
        device const char * src1,
        device       char * dst,
        threadgroup  char * shmem [[threadgroup(0)]],
...
kernel void kernel_mul_mm_id(
        constant lm_ggml_metal_kargs_mul_mm_id & args,
...
typedef decltype(mmv_fn<kernel_mul_mv_impl<half, half4, half, half4, lm_ggml_metal_kargs_mul_mv>>) mul_mv_impl_fn_t;

template<mul_mv_impl_fn_t impl_fn>
kernel void kernel_mul_mv_id(
        constant lm_ggml_metal_kargs_mul_mv_id & args,
        device const char * src0s,
        device const char * src1,
        device       char * dst,
        device const char * ids,
    ...
    lm_ggml_metal_kargs_mul_mv args0 = {
        /*.ne00 =*/ args.ne00,
        /*.ne01 =*/ args.ne01,
        /*.ne02 =*/ 1, // args.ne02,
        /*.nb00 =*/ args.nb00,
